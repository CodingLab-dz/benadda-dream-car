...
export const Banner = () => {
    ...
    return (
        <div className='w-full h-fit mt-[100px] px-3 lg:px-0' data-aos="fade-up" data-aos-duration="1200">
            <div className='w-full max-w-7xl h-[300px] mintablet:h-[400px] tablet:h-[500px] mx-auto bg-center bg-cover relative'>
                ...
                <div className='w-full h-full absolute bottom-0 left-0 flex flex-col justify-end items-center bg-gradient-to-t from-[#000000] to-[#0505050d] z-10 pb-10 tablet:pb-20 text-white'>
                    ...
                    <Link href="https://wa.me/message/M35EHZUWKRZKG1"><Button className='bg-transparent border border-white'>Prendre une reservation</Button></Link>
                </div>
            </div>
        </div>
    )
